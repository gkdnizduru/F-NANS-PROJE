...
function translateAuthError(message: string) {
  ...
  if (m.includes('too many requests')) return 'Çok fazla deneme yaptınız, lütfen biraz bekleyin.'
  if (m.includes('user not found')) return 'E-posta adresi veya şifre hatalı.'
  if (m.includes('invalid email')) return 'Lütfen geçerli bir e-posta adresi girin.'
    ...
    <div className="h-screen lg:grid lg:grid-cols-2">
      <div className="flex flex-col justify-center px-8 sm:px-12 lg:px-20 bg-[#0B1120]">
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="mt-10">
            <h1 className="text-3xl font-bold tracking-tight text-white">Hesabınıza giriş yapın</h1>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-xs text-slate-300 hover:text-slate-200">
                  Şifreni mi unuttun?
                </Link>
              </div>
